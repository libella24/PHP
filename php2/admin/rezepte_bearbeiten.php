...
<form action="rezepte_bearbeiten.php" method="post">
    ...
    <div class="zutatenliste">
        ...
        $bloecke = 1;
        $result = query("SELECT *  FROM zutaten_zu_rezepte WHERE rezept_id = '{$sql_id}' ORDER BY id ASC");//Rezept_id entspricht meinem aktuell geöffneten Rezept
                ...
                <div>
                    ...
                    <select name="zutaten_id[]" id="zutaten_id"> 
                        ...
                        while($zutat= mysqli_fetch_assoc($zutaten_result)){
                            ...
                            echo ">{$zutat["titel"]}</option>";  // Option wird zugefügt, wenn Zuordnung entspricht...
                        }
                        ?>
                    </select>
                </div>
